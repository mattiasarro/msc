...
The required theoretical background is covered in section \ref{bg}: the different ways to represent input, various neural network models that could be used, unsupervised and semi-supervised learning methods, joint training, ensembling and active learning.
