...
There is at times ambiguity as to which category a product should belong (e.g. long jacket vs short coat), therefore even hand-assigned labels are somewhat arbitrary.
The similarity between categories is ignored by this loss function: a coat that is misclassified as an earring has the same loss value as a coat that is classified as a jacket.
