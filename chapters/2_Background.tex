...
The former case is common, and remains a part in even the other options, as one still needs to decide on the intervals for the hyperparameters.
...
The fourth option considers the set of hyperparameters as an input surface and the model's validation performance as an output to be optimised; a common approach for this is Bayesian optimisation.
