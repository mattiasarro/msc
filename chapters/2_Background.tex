...
One related approach is offered by \cite{towards}, where a class-conditional VAE is used to generate synthetic data for a discriminator network.
They use it for conditional text generation, but also report higher accuracy in semisupervised setting than the approach described just above.
The author has implemented this model and open sourced it\footnote{https://github.com/mattiasarro/seq2seq-cvae-tensorflow}.
