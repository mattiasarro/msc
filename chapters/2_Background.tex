...
Some reports have emerged \cite{vae_bad} that fail to reproduce this success on more complex datasets such as CIFAR-10

One related approach is offered by \cite{towards}
