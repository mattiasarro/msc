...
Generative adversarial networks (GANs) are an interesting and trendy research field capable of synthesising realistic data, but also useful for learning good representations of data.
