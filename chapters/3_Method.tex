...
The nearest neighbour similarity search may pick up qualities of the image that are not related to the product in question, such as background, fashion model, viewpoint; this is un-intended but is acceptable, and it could be argued creates a product listing which is more homogenous and therefore more aesthetically pleasing.
...
\end{figure}
\begin{figure}
  \includegraphics[width=\linewidth]{figures/compare/chair_tokenised}
