...
\begin{figure}
  ...
  \caption{Unregularised training loss of rule-based objective. Dark red: only rule-based objective. Light blue: until step 35K, only rule-based objective, then a combination of rule-based and exclusive. Purple: . Shuffle buffer size: 15K.}
  \label{pretrain}
\end{figure}
