...
Figure \ref{fig:af1} shows a screenshot of the most common Airflow pipeline that preprocesses the data, trains and predicts for all products.
...
All pipelines create their own set of directories in GCS: the folder name becomes the \textit{run\_id}.
